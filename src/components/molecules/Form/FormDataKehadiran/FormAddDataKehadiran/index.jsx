...
const FormAddDataAttendance = () => {
  ...
  const [employeeData, setDataEmployee] = useState([]);
  const [attendanceData, setDataKehadiran] = useState([]);
  ...
  const filteredDataPegawai = employeeData.filter((pegawai) =>
    pegawai.employee_name.toLowerCase().includes(searchKeyword.toLowerCase())
  );
              ...
              <tbody>
                {filteredDataPegawai
                  ...
                  .map((data, index) => {
                    const isNameExists = attendanceData.some(
                      (attendence) =>
                        attendence.employee_name === data.employee_name
                    );
