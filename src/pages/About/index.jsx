            ...
            <div className="dark:bg-boxdark">
                <div className="parent pt-16 my-16">
                    <div>
                        ...
                        >
                            <h3 className="text-neutral text-center dark:text-white">What is OrgOpti?</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                            ...
                            >
                                ...
                                OrgOpti is a system used by companies to manage employee payroll processes efficiently and accurately.
                                    This system plays a key role in automating various payroll-related tasks, such as salary calculation, absenteeism processing, and payment of employee wages.
                                </p>
                                <br />
                                <p className="font-medium text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left dark:text-white">
                                In OrgOpti, employee information such as personal data, position and salary level is stored centrally.
                                    Every month, the system will take employee attendance data and calculate salaries based on existing information.
